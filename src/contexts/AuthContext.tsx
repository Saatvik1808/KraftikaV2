...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || (typeof window !== 'undefined' ? '/api/backend' : (process.env.VERCEL_URL ? 'https://' + process.env.VERCEL_URL + '/api/backend' : 'http://localhost:9002/api/backend'))
