...
import { ShoppingCart, Heart, Share2, Star, MessageSquareText } from "lucide-react"; // Added Star, MessageSquareText
import { cn } from "@/lib/utils";
import { useToast } from "@/hooks/use-toast";
import allProductsData from "@/data/products.json";
import allReviewsData from "@/data/reviews.json"; // Import reviews data
        ...
        <div className="mt-16 md:mt-24 pt-10 border-t border-border/20">
            ...
            {reviews.length === 0 ? (
                ...
                >
                    ...
                    {/* Optionally, add a "Write a review" button here later */}
                </motion.div>
            ) : (
